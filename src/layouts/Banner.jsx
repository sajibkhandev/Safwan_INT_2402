...
const Banner = () => {
  return (
    <section style={{backgroundImage:`url(${BannerImage})`}} className='group overflow-hidden z-10  relative w-full bg-no-repeat bg-cover bg-center py-[100px] md:py-[221px] px-3 md:px-0 '>
        <div style={{backgroundImage:`url(${BannerImageTwo})`}} className='group-hover:right-0 duration-700 -z-10 absolute top-0 -right-full  w-5/12 h-full  bg-no-repeat bg-cover bg-center'></div>
        <Container>
